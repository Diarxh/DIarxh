        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                <h2>{{ $user->name }}</h2>
                <h3>{{ $roles->isNotEmpty() ? $roles->first()->name : 'No Role' }}</h3> <!-- Menampilkan name dari peran pertama -->
              ...
              <div class="tab-content pt-2">
                ...
                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8">{{ $guru->school_name ?? 'Belum ada informasi sekolah.' }}</div>
                    </div>

                    <div class="row">
                        <div class="col-lg-3 col-md-4 label">Job</div>
                        <div class="col-lg-9 col-md-8">{{ $guru->nuptk ?? 'Belum ada informasi nuptk.' }}</div>
                    </div>

                    <div class="row">
                        <div class="col-lg-3 col-md-4 label">Country</div>
                        <div class="col-lg-9 col-md-8">{{ $guru->city ?? 'Belum ada informasi negara.' }}</div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8">{{ $guru->phone_number ?? 'Belum ada nomor telepon.' }}</div>
                    </div>
                ...
                @endif
                  ...
                  <form action="{{ route('profile.save') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="name" type="text" class="form-control" id="fullName" value="{{ $guru->name ?? '' }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <label for="'NiceAdmin/address" class="col-md-4 col-lg-3 col-form-label">Address</label>
                        <div class="col-md-8 col-lg-9">
